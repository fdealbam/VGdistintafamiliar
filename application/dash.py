...
mytitle=' '
tabtitle='Violencia de género en todas sus modalidades distinta a la violencia familiar'
    ...
    html.Br(),
        ...
        dbc.Row(
           [
               ...
               dbc.Col(html.P("Violencia de género distinta a la violencia familiar"),
...
#Cintillo 00    
    dbc.Row(
       ...
       str(TASAVGDISTFAM) +" delitos por cada 100 mil habitantes. "+
                    "Este tablero analítico se compone de una sección en la cual tratamos la violencia de género en todas sus modalidades distinta a la violencia familiar, observamos "
    ...
    html.Br(),
     ...
     html.Br(),
       html.Br(),
        dbc.Row(
           [
               dbc.Col(html.P("Evolución de la incidencia de violencia de género distinta a la violencia familiar" ),
     ...
     dbc.Row(
           [
               ...
               dbc.Col(dbc.Button(([html.H5("2020", style={"font-size": 18,"color": "black","background-color": "white"}),
                                    ...
                                    dbc.CardImg(src="https://github.com/fdealbam/VGdistintafamiliar/blob/main/application/static/Mapa%20vgdistintaafamiliar%20Total2020.png?raw=true",
                                                 style={"background-color":"white"}),
               ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
     ...
     dbc.Row(
           [
               dbc.Col(dbc.Button(([html.P("México", style={"font-size": 30,"color": "black","background-color": "white"}),
                  ...
                  style={'size': 2,}),
                          html.P(
                          "Los 10 municipios con más violencia de género distinta  a la violencia famimliar fueron: Ecatepec de Morelos (1,156), Toluca (793), Cuautitlán Izcalli (448),"
                              " Naucalpan de Juárez (448), Nezahualcóyotl (428), Atizapán de Zaragoza (375), Tlalnepantla de Baz (373),"
                              " Tecámac (274), Tultitlán (274) e Ixtapaluca (273).",
               ...
               dbc.Col(dbc.Button(([html.P("Veracruz", style={"font-size": 30,"color": "black","background-color": "white"}),
                       dbc.CardImg(src="https://github.com/fdealbam/VGdistintafamiliar/blob/main/application/static/ver.jpeg?raw=true",
                                    style={'size': 2,}),
                       html.P(
                           "Los 10 municipios con más violencia de género distinta  a la violencia famimliar fueron: Veracruz (1,450), Xalapa (573), Coatzacoalcos (506),"
                           " Poza Rica de Hidalgo (203), Boca del Río (164), Tuxpan (144), Minatitlán (125), Cosoleacaque (90),"
                           " Cosamaloapan de Carpio (88) y Papantla (78).",
                              style={'font-size': 14, "font-family":"Arial", "text-align":"justify" }),
                       ]), style={"background-color":"white",
                         "box-shadow": "10px 20px 30px black",
                        # 'margin-left': '10px',
    ...
    #[
        dbc.Row([
                ...
                html.P(
                    ...
                    "Como se indica en cada caso, la información sobre el delito violencia de género en todas sus modalidades distinta a la violencia familiar proviene del Secretariado "
